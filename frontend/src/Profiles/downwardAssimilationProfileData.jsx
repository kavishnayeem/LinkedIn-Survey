const downwardAssimilationProfileData=[
    {
        "id": "DOWNWARD-ASSIMILATION-01",
        "name": "James Walker",
        "opentowork":"Yes",
        ...
        "experience": [
          ...
          {
            "company": "Piesanos Stone Fired Pizza",
            "title": "Server",
          ...
          },
          {
            ...
            "bullets": [
              "Helped with referrals.",
              "Worked with clients on the phone."
            ]
          }
        ],
        "education": [
        ...
        "experience": [
          {
            ...
            "bullets": [
              "Achieved career sales worth $3,787 and featured in the company newsletter.",
              "Promoted from Rookie to Sales Representative, and then to Advanced Sales Representative."
            ]
          }
        ],
        "education": [
